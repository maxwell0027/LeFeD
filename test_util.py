...
def test_calculate_metric(net, test_dataset, num_classes=2, save_result=False, test_save_path='./save', stride_xy=16, stride_z=4):
    net.eval()
    ...
    avg_metric = test_all_case(net, image_list, num_classes=num_classes,
                               patch_size=(96, 96, 96), stride_xy=stride_xy, stride_z=stride_z,
